...
ALTER TABLE titles ADD title varchar(35) NOT NULL;
SELECT * FROM TITLES
...
-- using conditionals between two columns
SELECT first_name, last_name
FROM employees
...
-- create new table with existing code
SELECT first_name, last_name
